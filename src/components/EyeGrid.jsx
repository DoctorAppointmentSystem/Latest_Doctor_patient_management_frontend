...
function EyeGrid({ title, sph = "", cyl = "", axis = "", va = "", add = "", n6 = "", onChange, section, side, readOnly = false }) {
    ...
    <div className="w-full max-w-md rounded-lg border border-gray-400 bg-white shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-4 text-center">
        ...
        <div className="p-3 font-mono border-b border-r border-gray-300">
          <input type="text" value={sph} onChange={handle('sph')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>
        <div className="p-3 font-mono border-b border-r border-gray-300">
          <input type="text" value={cyl} onChange={handle('cyl')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>
        <div className="p-3 font-mono border-b border-r border-gray-300">
          <input type="text" value={axis} onChange={handle('axis')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>
        <div className="p-3 font-mono border-b border-gray-300">
          <input type="text" value={va} onChange={handle('va')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>

        {/* Row 3: Bottom Section (Spanning 2 columns each) */}
        <div className="col-span-2 p-3 font-medium border-r border-gray-300">
          <input type="text" value={add} onChange={handle('add')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>
        <div className="col-span-2 p-3 font-medium">
          <input type="text" value={n6} onChange={handle('n6')} readOnly={readOnly} className="w-full text-center outline-none" />
        </div>
      </div>
    </div>
  );
